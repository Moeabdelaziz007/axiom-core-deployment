...
/**
 * Universal Deployment Script - Bypasses TypeScript strict checking
 * Uses 'any' types to overcome Anchor version compatibility issues
 */
...
async function main() {
  ...
  // Cast program to any to bypass strict type checks
  ...
  try {
    ...
    // 5. Initialize vault with program
    console.log("\n🏦 Initializing vault...");
