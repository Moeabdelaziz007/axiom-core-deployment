...
export const AgentChat = ({ agentId, agentName, agentType, onClose }: AgentChatProps) => {
    ...
    const [activeTab, setActiveTab] = useState<'chat' | 'evolution'>('chat');
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            ...
            <div className="flex gap-4 mb-4 border-b border-white/10 px-2">
                <button
                    ...
                    className={`pb-2 text-sm font-medium transition-colors relative ${activeTab === 'chat' ? 'text-primary' : 'text-gray-400 hover:text-white'
                        }`}
                >
                ...
                <button
                    ...
                    className={`pb-2 text-sm font-medium transition-colors relative ${activeTab === 'evolution' ? 'text-cyan-400' : 'text-gray-400 hover:text-white'
                        }`}
                >
                    <div className="flex items-center gap-2">
                        <Zap size={16} />
